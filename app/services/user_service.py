...
from app.constants import UserConstant
from app.exceptions import throw_if, ErrorCode, throw_if_not
from app.models.user import User
from app.schemas.user import UserRegisterRequest, LoginUserVO, UserLoginRequest, UserVO, UserQueryRequest, \
    UserUpdateRequest, UserAddRequest
...
class UserService:
    ...
    async def login(self, request: UserLoginRequest) -> LoginUserVO:
        ...
        # 验证密码
        encrypted_password = encrypt_password(request.user_password)
        throw_if(user["userPassword"] != encrypted_password, ErrorCode.PASSWORD_ERROR, "密码错误")
